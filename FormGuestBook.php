...
<body>
	<br>
	<center><h1>FORM BUKU TAMU</h1></center> <br>
	...
	<div class="card-body">
	<form method="POST" action="SimpanGuestBook.php">
		<div class="form-group row">
			<label for="posted" class="col-md-5 col-form-label">Posted</label>
			<div class="col-md-7">
				<input type="date" name="posted" class="form-control" id="posted">
				<br>
			</div>
		</div>

		<div class="form-group row">
			<label for="name" class="col-md-5 col-form-label">Nama</label>
			<div class="col-md-7">
				<input type="text" name="name" class="form-control" id="name" placeholder="isi nama lengkap anda">
				<br>
			</div>
		</div>
		...
		<div class="form-group row">
			<label for="city" class="col-md-5 col-form-label">Kota</label>
			<div class="col-md-7">
				<input type="text" name="city" class="form-control" id="city" placeholder="isi kota anda">
				<br>
			</div>
		</div>

		<div class="form-group row">
			<label for="message" class="col-md-5 col-form-label">Pesan</label>
			<div class="col-md-7">
				<input type="text" name="message" class="form-control" id="message" placeholder="isi pesan anda">
				<br>
			</div>
		</div>
